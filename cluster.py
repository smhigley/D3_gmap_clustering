...
tags = 'house'
url = 'http://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=' + flickr_api_key  + '&woe_id=2347602&has_geo=1&extras=geo&format=json&nojsoncallback=1&per_page=100';
